...
"keypress"!==c.type&&a.hotkeys.specialKeys[c.which],d=String.fromCharCode(c.which).toLowerCase(),e="",f={};a.each(["alt","ctrl","shift"],function(a,d){c[d+"Key"]&&b!==d&&(e+=d+"+")});c.metaKey&&!c.ctrlKey&&"meta"!==b&&(e+="meta+");c.metaKey&&"meta"!==b&&-1<e.indexOf("alt+ctrl+shift+")&&(e=e.replace("alt+ctrl+shift+","hyper+"));b?f[e+b]=!0:(f[e+d]=!0,f[e+a.hotkeys.shiftNums[d]]=!0,"shift+"===e&&(f[a.hotkeys.shiftNums[d]]=!0));d=0;for(var k=h.length;d<k;d++)if(f[h[d]])return g.apply(this,arguments)}}}}
